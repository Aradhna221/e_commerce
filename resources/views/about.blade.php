...
<div class="breadcumb-wrapper" data-bg-src="assets/img/breadcumb/breadcumb-bg.jpg">
    ...
    <!-- <div class="appointment-sec bg-top-center space" id="contact-sec" data-bg-src="assets/img/bg/appointment_bg_3.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 wow fadeInLeft">
                    <div class="title-area mb-25 text-center text-lg-start"><span class="sub-title">Make An
                            Appointment<img src="assets/img/theme-img/title_right.svg" alt=""></span>
            ...
            <div class="row slider-shadow th-carousel" data-slide-show="3" data-lg-slide-show="2" data-sm-slide-show="1"
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="testi-grid style3 wow fadeInUp">
                        <div class="testi-grid_img"><img src="assets/img/blog/mh.jpg" alt=""></div>
                        <h3 class="box-title">{{$f->message}}</h3>
                        <div class="testi-grid_profile">
                            <div class="media-body">
                                <h4 class="testi-grid_name">{{$f->name}}</h4>
                                <span class="commented-on"><i class="fal fa-email"></i>{{$f->email}}</span>
                                <p class="testi-grid_desig">Costumer</p>
                            </div>
                        </div>
