    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#ui-basic6" aria-expanded="false" aria-controls="ui-basic">
              <i class="icon-layout menu-icon"></i>
...
<td>
    <a href="/appointmentdelete/{{$u->id}}"><i class="fas fa-trash-alt" style="font-size:28px;color:red"></i></a>
    <a href="/appointupdate/{{$u->id}}"><i class="fas fa-edit"   style="font-size:28px;color:green"></i></a>
...
<a href="/exceldata6" class="btn btn-info fas fa-upload mt-3">&nbsp;Export To Excel</a>
