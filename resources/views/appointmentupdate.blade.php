...
<form action="{{URL::TO('fetchappointment/'.$mydata->id)}}" method="POST">
@csrf
<input type="text" name="Status" value="{{$mydata->Status}}" class="form-control mt-3">

<!-- <a href="../fetchappointment" class="btn btn-info mt-3">Update record</a> -->
