...
<td>{{$s->Shift}}</td>
<td>{{$s->Password}}</td>
<td> <img src="../{{$s->Profile}}" class=" rounded-circle " width="100%" height="120px" alt=""></td>


<td>
   <a  href="/receptiondelete/{{$s->id}}"><i class="fas fa-trash-alt" style="font-size:28px;color:red"></i></a>&nbsp;&nbsp;
   <a  href="/recupdate/{{$s->id}}"><i class="fas fa-edit"   style="font-size:28px;color:green"></i></a>
</td>
    </tr>
