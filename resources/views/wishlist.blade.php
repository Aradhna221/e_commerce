...
<!-- Mirrored from themeholy.com/html/rasm/demo/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Dec 2023 07:29:43 GMT -->
...
<body>
    ...
    <div class="th-menu-wrapper">
        <div class="th-menu-area">
            <div class="mobile-logo"><a href="/"><img src="../assets/img/logo.svg" alt="Rasm"></a>
            ...
            <div class="th-mobile-menu">
                <ul>
                    <li class="menu-item"><a href="..//">Home</a>
                        <ul class="sub-menu">
                            ...
                            <!-- <li class="menu-item-has-children"><a href="#">Multipage</a>
                                <ul class="sub-menu">
                                    <li><a href="/">Spa Message Parlor</a></li>
                                   
                                    <li><a href="home-hair-salon">Hair Salon</a></li>
                                    <li><a href="home-beauty-salon">Beauty Salon</a></li>
                                </ul>
                            </li> -->
                    ...
                    <li class="menu-item"><a href="../about">About us</a>
                        <!-- <ul class="sub-menu">
                            <li><a href="about">About Spa & Nail</a></li>
                           
                        </ul> -->
                    </li>
                    <li class="menu-item"><a href="../service">Services</a>
                    
                    </li>
                    <li><a href="shop-details">Feedback</a></li>
                    <li class="menu-item-has-children"><a href="#">login</a>
                    <ul class="mega-menu">
                        <li>
                    <ul><a href="../stylistlogin">StylistLogin</a></ul>
                    <ul><a href="../receptionlogin">ReceptionLogin</a></ul>
                    <ul>
                    @if (Route::has('login'))
                ...
                <div class="recent-post-wrap">
                    <div class="recent-post">
                        ...
                        <div class="media-body">
                            <h4 class="post-title"><a class="text-inherit" href="blog-details">Local residents and
                                    a few celebrities, too</a></h4>
                            <div class="recent-post-meta"><a href="blog"><i class="fal fa-calendar-days"></i>19
                                    June, 2023</a></div>
                        </div>
                    </div>
                    <div class="recent-post">
                ...
                <div class="row justify-content-end justify-content-lg-between align-items-center gy-2">
                    <div class="col-auto d-none d-lg-block">
                        <div class="header-links">
                            <ul>
                                <li><i class="far fa-phone"></i><a href="tel:+256214203215">+256 214 203 215</a></li>
                                <li><i class="far fa-envelope"></i><a href="mailto:info@rasm.com">info@rasm.com</a></li>
            ...
            <div class="menu-area">
                <div class="container th-container">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                            <div class="header-logo"><a href="/"><img src="../assets/img/logo.svg" alt="Rasm"></a>
                            </div>
                        </div>
                            ...
                            <nav class="main-menu d-none d-lg-inline-block">
                                <ul>
                                    ...
                                    <li class="menu-item"><a href="../service">Services</a>
                                        ...
                                        <!-- <ul class="sub-menu">
                                            <li><a href="service">Services of Spa & Nail</a></li>
                                            
                                           
                                        </ul> -->
                                    </li>
                                    <li class="menu-item-has-children mega-menu-wrap"><a href="#">login</a>
                    <ul class="mega-menu">
                        <li><a href="#"></a>
                    <ul><a href="../stylistlogin">StylistLogin</a></ul>
                    <ul><a href="../receptionlogin">ReceptionLogin</a></ul>
                                        ...
                                        <ul class="mega-menu">
                                            ...
                                            <li><a href="#">Pagelist 3</a>
                                                <ul>
                                                    <li><a href="appointment">Appointment</a></li>
                                                    <li><a href="team">Team</a></li>
                                                    <li><a href="appointmentrecord">Search Record</a></li>
                                                    <li><a href="team-details">Team Details</a></li>
                        ...
                        <div class="col-auto d-none d-xl-block">
                            <div class="header-button">
                                         ...
                                         <a href="../cart" class="icon-btn">
                                            ...
                                            <a class="icon-btn sideMenuToggler"><i class="fa-light fa-grid"></i></a> 
                                            <a href="../appointment" class="th-btn">Appointment Now<i class="fa-regular fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="breadcumb-wrapper" data-bg-src="../assets/img/breadcumb/breadcumb-bg.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Wishlist</h2>
                    ...
                    <table class="tinvwl-table-manage-list">
                        <thead>
                            <tr>
                                ...
                                <th class="product-date">Product type</th>
                        ...
                        <tbody>
                            <tr class="wishlist_item">
                                ...
                                <td class="product-price"><span class="woocommerce-Price-amount amount"><bdi><span
                                                class="woocommerce-Price-currencySymbol">$</span>{{$product->Price}}</bdi></span></td>
                          
                                <td class="product-date">  {{$product->Type}}</td>
                                <td class="product-stock">
                                    <p class="stock in-stock"><span><i class="fas fa-check"></i></span><span
                                            class="tinvwl-txt">In stock</span></p>
                                </td>
                                
                                    <td><a href="../cart" class="button th-btn"><i class="fal fa-shopping-cart"></i><span
                                            >Add to Cart</span></td></a>
                            </tr>
                        </tbody>
                    </table>
                </form>
                        ...
                        <div class="widget widget_nav_menu footer-widget">
                            ...
                            <div class="menu-all-pages-container">
                                <ul class="menu">
                                    ...
                                    <li><a href="booking">Work Gallery</a></li>
                                    <li><a href="contact">Privacy Policy</a></li>
                                    <li><a href="service">Our Services</a></li>
                                    <li><a href="price">Pricing Plans</a></li>
                                    <li><a href="contact">Contact Us</a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <p class="copyright-text text-white">© 2023 <a
                                href="https://themeforest.net/user/themeholy">Rasm</a>. All Rights Reserved.</p>
                    </div>
                    <div class="col-lg-6">
...
<!-- Mirrored from themeholy.com/html/rasm/demo/appointment.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Dec 2023 07:29:56 GMT -->
