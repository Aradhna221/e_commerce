...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <form action="{{URL::TO('recupdate/'.$mydata->id)}}" method="POST">
@csrf
<input type="time" name="time" value="{{$mydata->Time}}" class="form-control mt-3">
<input type="text" name="shift" value="{{$mydata->Shift}}" class="form-control mt-3">
