  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
        <li class="nav-item">
            <a class="nav-link" href="receptionfetchappointment">
          ...
          <li class="nav-item">
            <a class="nav-link" href="viewrecproduct">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">View Product</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="viewsalaryreception">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">View Reception Salary</span>
            </a>
          </li>
