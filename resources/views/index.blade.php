...
<section class="th-hero-wrapper hero-1" id="hero" data-bg-src="assets/img/bg/hero_bg_shape.png">
                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-6 col-xl-7">
                            <div class="hero-style1"><span class="sub-title" data-ani="slideindown"
                                    data-ani-delay="0.2s"><img src="assets/img/theme-img/title_left.svg"
                                        alt="shape">Best Spa Massages Parlor</span>
                                <h1 class="hero-title" data-ani="slideindown" data-ani-delay="0.3s">Elevate Your Body
                                    And Mind With Our Spa Massages</h1>
                                <div class="btn-group justify-content-center justify-content-lg-start"
                                    data-ani="slideindown" data-ani-delay="0.4s"><a href="service"
                                        class="th-btn">Explore Services<i
                                            class="fa-regular fa-arrow-right ms-2"></i></a></div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-5">
                            <div class="th-hero-img" data-ani="slideinup" data-ani-delay="0.2s"><img
                                    src="assets/img/hero/hero_bg_1_1.png" alt="">
                                <div class="th-hero-shape" data-ani="slideinright" data-ani-delay="0.4s"></div>
                                <div class="th-hero-shape2" data-ani="slideinright" data-ani-delay="0.7s"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row align-items-end">
                        <div class="col-lg-6 col-xl-7">
                            <div class="hero-style1"><span class="sub-title" data-ani="slideindown"
                                    data-ani-delay="0.2s"><img src="assets/img/theme-img/title_left.svg"
                                        alt="shape">Welcome Spa Massages Parlor</span>
                                <h1 class="hero-title" data-ani="slideindown" data-ani-delay="0.3s">Spa massages offer
                                    relaxation and stress various</h1>
                                <div class="btn-group justify-content-center justify-content-lg-start"
                                    data-ani="slideindown" data-ani-delay="0.4s"><a href="service"
                                        class="th-btn">Explore Services<i
                                            class="fa-regular fa-arrow-right ms-2"></i></a></div>
                        ...
                        <div class="col-lg-6 col-xl-5">
                            <div class="th-hero-img" data-ani="slideinup" data-ani-delay="0.2s"><img
                                    src="assets/img/hero/hero_bg_1_2.png" alt="">
                                <div class="th-hero-shape" data-ani="slideinright" data-ani-delay="0.4s"></div>
                                <div class="th-hero-shape2" data-ani="slideinright" data-ani-delay="0.7s"></div>
                            </div>
                        </div>
            ...
            <div class="th-hero-slide">
                <div class="container">
                    <div class="row align-items-end">
                        <div class="col-lg-6 col-xl-7">
                            <div class="hero-style1"><span class="sub-title" data-ani="slideindown"
                                    data-ani-delay="0.2s"><img src="assets/img/theme-img/title_left.svg" alt="shape">Our
                                    Spa Massages Parlor</span>
                                <h1 class="hero-title" data-ani="slideindown" data-ani-delay="0.3s">Soothe your body and
                                    mind with spa massages.</h1>
                                <div class="btn-group justify-content-center justify-content-lg-start"
                                    data-ani="slideindown" data-ani-delay="0.4s"><a href="service"
                                        class="th-btn">Explore Services<i
                                            class="fa-regular fa-arrow-right ms-2"></i></a></div>
                        ...
                        <div class="col-lg-6 col-xl-5">
                            <div class="th-hero-img" data-ani="slideinup" data-ani-delay="0.2s"><img
                                    src="assets/img/hero/hero_bg_1_3.png" alt="">
                                <div class="th-hero-shape" data-ani="slideinright" data-ani-delay="0.4s"></div>
                                <div class="th-hero-shape2" data-ani="slideinright" data-ani-delay="0.7s"></div>
                            </div>
                        </div>
        ...
        <div class="shape-mockup movingX d-none d-xl-block" data-top="12%" data-left="2%"><img
                src="assets/img/shape/flower_shape.svg" alt="shape"></div>
        <div class="shape-mockup shape2 jump" data-bottom="10%" data-left="0%"><img
                src="assets/img/shape/flower_1_3.svg" alt="shape"></div>
        <div class="shape-mockup hero_wrap d-none d-xl-block spin" data-top="3%" data-right="38%"><img
                src="assets/img/shape/flower_1_4.svg" alt="shape"></div>
        <div class="hero_flower bg-repeat movingX" data-bg-src="assets/img/shape/flower_shape.png"></div>
    </section>
            ...
            <div class="row slider-shadow th-carousel number-dots" id="serviceSlide" data-slide-show="4"
                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="service-box wow fadeInUp">
                        ...
                        <h3 class="box-title"><a href="service-details">Body Massages</a></h3>
                ...
                <div class="col-xl-6">
                    <div class="ps-xl-4 wow fadeInRight">
                        ...
                        <p class="mb-30">We also offer private rooms for more intimate treatments and couples' packages
                            for a romantic escape.</p><a href="about" class="th-btn">Discover More<i
    ...
    <section class="team-area bg-top-center overflow-hidden space" data-bg-src="assets/img/bg/team_bg_1.jpg">
            ...
            <div class="row slider-shadow th-carousel teamSlide1" id="teamSlide1" data-slide-show="3"
                ...
                <div class="col-sm-6 col-lg-4 col-xxl-3">
                    <div class="th-team team-card wow fadeInUp">
                        <div class="team-img"><img src="{{$v->Profile}}" alt="Team"></div>
                        <div class="team-card_content">
                            <div class="team-content">
                                <h3 class="box-title">{{$v->Name}}</h3><span
                                    class="team-desig">Specialist</span>
                                    <span
                                    class="team-desig">Time:{{$v->Time}}</span>
                                    <span class="team-desig">Shift:{{$v->Shift}}</span>
                ...
                <!-- <div class="col-sm-6 col-lg-4 col-xxl-3">
                    <div class="th-team team-card wow fadeInDown">
                        ...
                        <div class="team-card_content">
                            <div class="team-content">
                                <h3 class="box-title"><a href="team-details">Arlene McCoy</a></h3><span
                                    class="team-desig">Specialist</span>
                            </div>
                            <div class="team-social">
                                <div class="icon-btn"><i class="fa-light fa-plus"></i></div>
                ...
                <div class="col-sm-6 col-lg-4 col-xxl-3">
                    <div class="th-team team-card wow fadeInUp">
                        ...
                        <div class="team-card_content">
                            <div class="team-content">
                                <h3 class="box-title"><a href="team-details">Robert Fox</a></h3><span
                                    class="team-desig">Specialist</span>
                            </div>
                            <div class="team-social">
                                <div class="icon-btn"><i class="fa-light fa-plus"></i></div>
                ...
                <div class="col-sm-6 col-lg-4 col-xxl-3">
                    <div class="th-team team-card wow fadeInDown">
                        ...
                        <div class="team-card_content">
                            <div class="team-content">
                                <h3 class="box-title"><a href="team-details">Jade Smith</a></h3><span
                                    class="team-desig">Specialist</span>
                            </div>
                            <div class="team-social">
                                <div class="icon-btn"><i class="fa-light fa-plus"></i></div>
        ...
        <br><br>
        <div class="title-area text-center mt-3"><span class="sub-title style2">Our Receptions</span> <img
                    src="assets/img/theme-img/title_shape_1.svg" alt="">
                <h2 class="sec-title">Our Latest Receptions</h2>
            </div>
        <div class="row slider-shadow th-carousel teamSlide1" id="teamSlide1" data-slide-show="3"
                data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="1" data-xs-slide-show="1"
                data-arrows="true">
                ...
                <div class="col-sm-6 col-lg-4 col-xxl-3">
                    <div class="th-team team-card wow fadeInUp">
                        <div class="team-img"><img src="{{$s->Profile}}" alt="Team"></div>
                        <div class="team-card_content">
                            <div class="team-content">
                                <h3 class="box-title">{{$s->Name}}</h3><span
                                    class="team-desig">Receptionists</span>
                            </div>
                            <div class="team-social">
                                <div class="icon-btn"><i class="fa-light fa-plus"></i></div>
                                <div class="th-social"><a target="_blank" href="https://twitter.com/"><i
                    ...
                    <div class="price-card wow fadeInLeft">
                        ...
                        <div class="price-card_content">
                            ...
                            <div class="available-list">
                                ...
                                <div class="price-btn"><a href="price" class="th-btn">Book Now<i
            ...
            <div class="row slider-shadow th-carousel" id="blogSlide1" data-slide-show="3" data-lg-slide-show="2"
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="blog-card wow fadeInUp">
                        <div class="blog-img"><img src="{{$v->Image}}" alt="blog image"></div>
                        <div class="blog-card_wrapper">
                            <div class="blog-card_date">Date:<span class="blog-card_month">{{$v->Date}}</span></div>
                            <div class="blog-card-content">
                                <div class="blog-meta"><a href="blog"><i class="fa-solid fa-user"></i>By {{$v->Author}}</a> <a href="blog"><i class="fa-solid fa-tags"></i>{{$v->Category}}</a>
                                </div>
                                <h3 class="box-title"><a href="">{{$v->Blog_title}}</a></h3><a href="{{$v->Blog_link}}" class="line-btn">Read More<i
