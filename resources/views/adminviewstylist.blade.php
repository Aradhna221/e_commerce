...
<td>{{$v->Time}}</td>
<td>{{$v->Shift}}</td>
<td> <img src="../{{$v->Profile}}" class="mt-3 mb-3 " width="50%" height="120px" alt=""></td>


<td>
   <a  href="/stylistdelete/{{$v->id}}"><i class="fas fa-trash-alt" style="font-size:28px;color:red"></i></a>&nbsp;&nbsp;
   <a href="/stylistupdate/{{$v->id}}"><i class="fas fa-edit"   style="font-size:28px;color:green"></i></a>
</td>
    </tr>
...
<a href="/exceldata8" class="btn btn-info fas fa-upload mt-3">&nbsp;Export To Excel</a>
